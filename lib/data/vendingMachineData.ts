/**
 * Vending machine data types and utilities
 * Updated for complete MachineCard component system integration
 */
...
export interface MachineData {
  id: string;
  name: string;
  // model: string; // Commented out as per your structure
  shortDescription: string;
  description: string;
  images: MachineImage[];
  dimensions: { label: string; value: string }[] | string; // Support both formats
  features: FeatureItem[];
  specifications: SpecificationGroup[];
  productOptions: string[];
  bestFor: string[] | string; // Support both formats
  relatedMachines: {
    id: string;
    name: string;
    // model: string;
  ...
  highlights?: string[]; // Add highlights if not present
}
...
export const normalizeMachineData = (machine: MachineData | undefined) => {
  ...
  // Safely extract image with fallback
  const image = machine.images?.[0]?.src || "/images/placeholder.jpg";
  ...
  // Safely handle bestFor conversion
  let bestFor: string;
  if (typeof machine.bestFor === "string") {
    ...
    bestFor = "Suitable for various locations";
  }
  ...
  // Generate model field if needed (since it's commented out in the interface)
  const model = machine.id.toUpperCase().replace(/-/g, '-');

  return {
    ...machine,
    model, // Add model back for display purposes
    image,
    dimensions,
    bestFor,
    highlights,
...
const vendingMachineData: Record<string, MachineData> = {
  ...
  "0103": {
    ...
    shortDescription:
      "Space-efficient refrigerated vending solution with modern payment systems and energy-efficient cooling, perfect for smaller locations.",
    description:
      "This is our compact refrigerated vending machine designed for locations where space is at a premium but quality refreshment options are essential. Despite its smaller footprint, this machine delivers advanced technology and reliability. It features energy-efficient cooling, versatile payment options, and can accommodate a variety of refrigerated products. The space-saving design makes it perfect for smaller offices, break rooms, or areas with limited floor space while maintaining professional appearance and functionality.",
    images: [
      {
        id: 1,
        src: "/images/machines/compact-refrigerated-vending-machine.jpg",
        alt: "Front view of Compact Refrigerated Machine with snacks and beverages",
      },
    ],
    dimensions: [
    ...
    features: [
      {
        ...
        description:
          "Optimized dimensions for installation in smaller areas while maintaining substantial product capacity and selection variety.",
      ...
      },
      {
        ...
        description:
          "Advanced refrigeration system that maintains proper temperature while minimizing power consumption for eco-friendly operation.",
      ...
      },
      {
        ...
        description:
          "Integrated payment system accepting credit/debit cards, mobile payments, and cash for maximum user convenience.",
      ...
      },
      {
        ...
        description:
          "Specially designed interior configuration that maximizes product variety despite the compact external dimensions.",
      ...
      },
      {
        ...
        description:
          "Remote monitoring system that tracks product levels in real-time to ensure timely restocking and minimize out-of-stock situations.",
      ...
      },
      {
        ...
        description:
          "Energy-efficient LED lighting system that attractively showcases products while consuming minimal power and generating less heat.",
    ...
    relatedMachines: [
      ...
      {
        id: "0101",
        name: "Premium Non-Refrigerated Snack Machine",
        // model: "0101",
    ...
    // Premium Non-Refrigerated Snack Machine  
  "Premium Machine": {
    id: "0101",
    name: "Premium Non-Refrigerated Snack Machine",
    shortDescription:
      "Advanced snack vending solution with large HD touchscreen display, featuring versatile payment options and high-capacity storage for a wide variety of non-refrigerated products.",
    description:
      "This is our premium non-refrigerated vending machine designed specifically for snacks, confectionery, and shelf-stable products. Featuring a modern 21.5\" HD touchscreen interface and multiple payment options, this machine provides an engaging purchase experience for users. With a substantial capacity for up to 50 different product selections and adjustable spirals to accommodate items of various sizes, it offers excellent variety and flexibility. Perfect for locations where refrigeration isn't required but a diverse selection of quality snacks is desired.",
    images: [
      {
        id: 1,
        src: "/images/machines/amp-premium-non-refrigerated-vending-machine.png",
        alt: "Front view of Premium Non-Refrigerated Snack Machine with colorful product display",
      },
    ],
    dimensions: [
    ...
    features: [
      {
        ...
        description:
          "Interactive high-definition display with intuitive navigation for enhanced user experience and easy product selection.",
      ...
      },
      {
        ...
        description:
          "Integrated payment system accepting credit/debit cards, mobile payments (Apple Pay, Google Pay), and traditional cash methods.",
        icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" /></svg>',
      },
      {
        title: "Bill Recycler Technology",
        description:
          "Advanced cash handling system that uses accepted bills for change, reducing the need for frequent coin refills.",
      ...
      },
      {
        ...
        description:
          "Customizable product spirals that can be configured to accommodate various product sizes for maximum flexibility.",
      ...
      },
      {
        ...
        description:
          "Cloud-based inventory tracking system that provides real-time data on product levels, sales patterns, and machine status.",
      ...
      },
      {
        ...
        description:
          "Optimized power consumption with energy-saving LED lighting and standby mode that reduces electrical usage during low-traffic periods.",
    ...
    specifications: [
      {
        ...
        items: [
          ...
          { label: "Weight", value: "700 lbs (318 kg)" },
          { label: "Cabinet Construction", value: "Powder-coated steel" },
          { label: "Front Glass", value: "Triple-pane heated glass" },
          { label: "Insulation", value: "High-efficiency insulation" },
        ],
      },
      {
        category: "Capacity & Configuration",
        items: [
          { label: "Product Selections", value: "50+ different products" },
          { label: "Spirals", value: "Adjustable for various product sizes" },
          { label: "Maximum Products", value: "Up to 500+ items depending on size" },
        ],
      },
      {
        category: "Technology Features",
        items: [
          ...
          { label: "Controller", value: "Advanced microprocessor system" },
          { label: "Connectivity", value: "4G LTE, Wi-Fi, Ethernet" },
          { label: "Remote Monitoring", value: "Real-time inventory and diagnostics" },
        ],
      },
      {
        category: "Payment Systems",
        items: [
          { label: "Card Reader", value: "EMV compliant with NFC" },
          { label: "Contactless", value: "Apple Pay, Google Pay, Samsung Pay" },
          { label: "Cash Handling", value: "Bill recycler ($1-$100)" },
          { label: "Coin Mechanism", value: "Multi-coin with change dispensing" },
        ],
      },
      {
        ...
        items: [
          ...
          { label: "Lighting", value: "Energy-efficient LED lighting" },
          { label: "Certifications", value: "UL, Energy Star qualified" },
        ],
      },
    ],
    ...
    bestFor: [
      "Large offices and corporate environments",
  ...
  "0102": {
    ...
    name: "Standard Refrigerated Machine",
    shortDescription:
      "A versatile refrigerated vending machine designed for reliability and performance in medium to high-traffic locations.",
    description:
      "This is our standard refrigerated vending solution that balances capacity with space efficiency. This machine offers reliable performance for mid-sized locations, featuring modern payment systems and energy-efficient cooling technology. With a capacity for 40+ product selections and a sleek design, it provides a robust option for locations where a full-sized machine may not be required but substantial variety is still needed. As with all our machines, it comes with professional installation and complete maintenance service.",
    images: [
      {
        id: 1,
        src: "/images/machines/amp-standard-refrigerated-vending-machine-front-bg.jpg",
        alt: "Front view of Standard Refrigerated Machine",
      },
      // {
      //   id: 2,
      //   src: "/images/machines/amp-standard-refrigerated-vending-machine.jpg",
      //   alt: "Angle view of Standard Refrigerated Machine",
      // },
    ],
    dimensions: [
    ...
    features: [
      {
        title: "Energy-Efficient Cooling",
        description:
          "Advanced refrigeration system that maintains optimal temperature while minimizing power consumption and environmental impact.",
        icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" /></svg>',
      },
      {
        title: "Smart Inventory Tracking",
        description:
          "Real-time monitoring system that tracks product levels and purchase patterns to optimize restocking and product selection.",
      ...
      },
      {
        ...
        description:
          "Accepts credit/debit cards, mobile payments, and cash, providing convenience for all customers regardless of preferred payment method.",
        icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.75c.414 0 .75.336.75.75v.75m0 0H18a2.25 2.25 0 002.25-2.25V4.5a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 4.5m10.5-1.5h.75c.414 0 .75.336.75.75v.75M3 18.75v.75c0 .414.336.75.75.75h.75M3.75 18h16.5m-16.5 0h-.75a.75.75 0 01-.75-.75v-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25" /></svg>',
      },
      {
        title: "Adjustable Shelving",
        description:
          "Configurable shelf system that can be adapted to accommodate various product sizes and maximize the selection available to customers.",
      ...
      },
      {
        ...
        description:
          "Advanced monitoring system that alerts our technicians to potential issues before they become problems, ensuring minimal downtime.",
        icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M9 17.25v1.007a3 3 0 01-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0115 18.257V17.25m6-12V15a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 15V5.25m18 0A2.25 2.25 0 0018.75 3H5.25A2.25 2.25 0 003 5.25m18 0V12a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 12V5.25" /></svg>',
      },
      {
        title: "Energy-Saving Mode",
        description:
          "Intelligent power management system that reduces energy consumption during periods of low usage while maintaining product freshness.",
        icon: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" /></svg>',
      },
    ],
    specifications: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "Shelving", value: "5 adjustable shelves" },
          {
            ...
            value: "Up to 360 items depending on size",
          },
        ],
      },
      {
        ...
        items: [
          ...
          { label: "Connectivity", value: "4G LTE, Wi-Fi option" },
          {
            ...
            value: "Inventory tracking and alerts",
          },
        ],
      },
      {
        ...
        items: [
          ...
          { label: "Cash Handling", value: "Bill acceptor ($1-$20)" },
          {
            label: "Coin Mechanism",
            value: "Multi-coin with change dispensing",
          },
        ],
      },
      {
        ...
        items: [
          ...
          {
            label: "Refrigerant",
            value: "R290 environmentally friendly refrigerant",
          },
        ],
      },
      {
    ...
    relatedMachines: [
      {
        ...
        // model: "non-refrigerated",
        image:
          "/images/machines/amp-premium-non-refrigerated-vending-machine.jpg",
      },
    ],
    category: "refrigerated",
    highlights: [
  ...
  "0104": {
    id: "0104",
    name: "Standard Non Refrigerated Machine",
    shortDescription:
      "A versatile refrigerated vending machine designed for reliability and performance in medium to high-traffic locations.",
    description:
      "This is our standard refrigerated vending solution that balances capacity with space efficiency. This machine offers reliable performance for mid-sized locations, featuring modern payment systems and energy-efficient cooling technology. With a capacity for 40+ product selections and a sleek design, it provides a robust option for locations where a full-sized machine may not be required but substantial variety is still needed. As with all our machines, it comes with professional installation and complete maintenance service.",
    images: [
      ...
      // {
      //   id: 2,
      //   src: "/images/machines/standard-refrigerated-vending-machine.jpg",
      //   alt: "Angle view of Standard Refrigerated Machine",
      // },
    ],
    dimensions: [
  ...
  "Standard Refrigerated Machine": {
    id: "0102",
    name: "Standard Refrigerated Machine",
    // model: 'Standard Refrigerated Machine',
    shortDescription:
      "A versatile refrigerated vending machine designed for reliability and performance in medium to high-traffic locations.",
    description:
      "This is our standard refrigerated vending solution that balances capacity with space efficiency. This machine offers reliable performance for mid-sized locations, featuring modern payment systems and energy-efficient cooling technology. With a capacity for 40+ product selections and a sleek design, it provides a robust option for locations where a full-sized machine may not be required but substantial variety is still needed. As with all our machines, it comes with professional installation and complete maintenance service.",
    ...
    relatedMachines: [
      {
        id: "0101",
        name: "Non-Refrigerated Premium Snack Machine",
        // model: "non-refrigerated",
        image:
          "/images/machines/amp-premium-non-refrigerated-vending-machine.jpg",
      },
  ...
  "0101": {
    ...
    images: [
      {
        id: 1,
        src: "/images/machines/amp-premium-non-refrigerated-vending-machine-front-bg.jpg",
        alt: "Front view of Non-Refrigerated Premium Snack Machine",
      },
      // {
      //   id: 2,
      //   src: "/images/machines/amp-premium-non-refrigerated-vending-machine.jpg",
      //   alt: "Angle view of Premium Non-Refrigerated Snack Machine",
      // },
    ],
    dimensions: [
      { label: "Width", value: "50 inches (127 cm)" },
    ...
    relatedMachines: [
      ...
      },
      {
        ...
        name: 'Compact Refrigerated Machine',
        // model: '0103',
        image: '/images/products/compact-refrigerated-vending-machine.jpg'
      },
      {
        id: '0104',
        name: 'Non-Refrigerated Snack Machine',
        // model: '0104',
        image: '/images/machines/standard-non-refrigerated-vending-machine.jpg'
      }
    ],
    category: 'non-refrigerated'
  }
...
//   },
 ...
 // Compact Refrigerated Machine
  ...
  //   description: 'The 0103 is our compact refrigerated vending machine, engineered specifically for locations where space is at a premium but quality refreshment options are still essential. Despite its smaller footprint, this machine delivers the same advanced technology and reliability as our larger models. It features energy-efficient cooling, versatile payment options, and can accommodate a surprising variety of refrigerated products. The space-saving design makes it perfect for smaller offices, break rooms, or spaces with limited floor area.',
  //   images: [
  //     { 
  //       id: 1, 
  //       src: '/images/products/placeholder.jpg', 
  //       alt: 'Front view of Compact Refrigerated Machine 0103' 
  //     },
  //     // { 
  //     //   id: 2, 
  //     //   src: '/images/products/placeholder.jpg', 
  //     //   alt: 'Side view of Compact Refrigerated Machine 0103' 
  //     // },
  //     // { 
  //     //   id: 3, 
  //     //   src: '/images/products/placeholder.jpg', 
  //     //   alt: 'Angle view of Compact Refrigerated Machine 0103' 
  //     // },
  //     // { 
  //     //   id: 4, 
  //     //   src: '/images/products/placeholder.jpg', 
  //     //   alt: 'Interior view of Compact Refrigerated Machine 0103' 
  //     // }
  //   ],
  //   dimensions: [
  //     { label: 'Width', value: '30 inches (76 cm)' },
