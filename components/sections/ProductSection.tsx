...
const ProductSection = () => {
  ...
  const productCatalog: Product[] = [
    ...
    { id: 'sprite', name: 'Sprite', category: 'beverages', image: '/images/products/placeholder.jpg' },
    { id: 'pepsi', name: 'Pepsi', category: 'beverages', image: '/images/products/placeholder.jpg' },
