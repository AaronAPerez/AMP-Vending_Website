          ...
          >
            <GlareCard className="w-full max-w-[320px] h-auto">
              ...
              >
                ...
                <div className="p-4 sm:p-6 pt-10 text-center flex-grow flex flex-col justify-between">
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold text-[#F5F5F5] mb-3 leading-tight">
                      {step.title}
                    </h3>
