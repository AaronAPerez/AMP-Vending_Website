...
const BackgroundOverlayCard = ({ product }: { product: Product }) => {
  ...
  return (
    <div className="relative group h-40 overflow-hidden rounded-xl shadow-xl">
      {/* Background Image */}
      ...
      <div className="absolute top-2 left-2 right-2 flex justify-between">
        ...
        {product.healthy && (
          <div className="px-2 py-1 bg-green-500 text-white text-xs rounded-full backdrop-blur-sm">
            Healthy
          </div>
        )}
      </div>
