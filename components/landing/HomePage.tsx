...
const HomePage = () => {
  ...
  return (
    ...
    <section 
        ...
        className="relative pb-16 bg-gradient-to-b from-[#000000] to-[#111111] overflow-hidden"
      ...
      <div className="absolute inset-0 bg-radial-gradient-dark opacity-30" aria-hidden="true">  
      </div>
      ...
      <section 
        ...
        className="relative pb-16 bg-gradient-to-r from-[#111111] via-black to-[#111111]"
