...
// export const MachineCard = ({ machine, index, isActive, onHover }: MachineCardProps) => {
...
//       <div 
//         className="relative h-72 md:h-80 overflow-hidden cursor-pointer transform transition-transform duration-300 hover:scale-[1.02] focus-within:scale-[1.02]"
...
//         >
//           <span className={`px-2 py-2 rounded-full text-sm font-medium text-white shadow-lg ${
...
//         >
//           <span className="bg-[#FD5A1E] text-[#000000] px-2 py-2 rounded-full font-medium text-sm shadow-lg flex items-center">
...
//           <div className="bg-[#FD5A1E]/60 backdrop-blur-sm px-6 py-3 rounded-full text-[#000000] font-bold text-sm transform translate-y-4 group-hover:translate-y-0 focus-within:translate-y-0 transition-transform duration-300 flex items-center">
...
//             className={`object-contain py-6 sm:py-4 md:py-8 mx-auto transition-all duration-700 ${
...
//       model: 'KM-VMR-40-B',
//       image: '/images/machines/amp-standard-refrigerated-vending-machine-front-bg.jpg',
...
//       model: 'KM-VMNT-50-B',
//       image: '/images/machines/amp-premium-non-refrigerated-vending-machine-front-bg.jpg',
