...
interface IconProps {
  ...
  /**
   * Current color (will use currentColor if not specified)
   */
  color?: string;
}

/**
 * Icon component - renders SVG icons based on name
 */
export const Icon: React.FC<IconProps> = ({
  ...
  // Style object with size and color
  const style = {
    width: `${size}px`,
    height: `${size}px`,
    ...(color ? { color } : {}),
  ...
  const iconMap: Record<string, React.ReactNode> = {
    ...
    tech: (
      <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
        <path d="M18 10h-4V4h4v6zm-4 2h-4v8h4v-8zm8 0h-4v8h4v-8zm-12 0H6v8h4v-8zm0-2V4H6v6h4z" />
      </svg>
    ),
