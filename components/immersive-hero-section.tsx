  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full h-full px-4 py-16 md:py-0 md:px-8">
        <div className="w-full max-w-7xl mx-auto flex flex-col md:flex-row md:items-center md:min-h-[80vh]">
          {/* Text content - stacked on mobile, left-aligned on desktop */}
          <div className="w-full md:w-1/2 text-center md:text-left mb-8 md:mb-0">
            <h1 
              id="hero-heading"
              className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#F5F5F5] mb-4 leading-tight"
            >
              {title}
              {highlightedTitle && (
                <>
