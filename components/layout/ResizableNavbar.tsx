   ...
   <div className="fixed top-0 z-50 w-full">
      ...
      >
        ...
        {isMenuOpen && (
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-[#4d4d4d]/30">
              {navItems.map((item) => (
                <div key={item.name}>
                  {item.children ? (
                    ...
                    <div>
                      <button
                        className="w-full flex items-center justify-between px-3 py-2 rounded-md text-base font-medium text-[#F5F5F5] hover:bg-[#4d4d4d] hover:text-[#FD5A1E]"
                        onClick={(e) => toggleSubmenu(item.name, e)}
                      >
                        {item.name}
                        <svg
                        ...
                        >
                          {item.children.map((child) => (
                            <Link
                              key={child.name}
                              href={child.path}
                              className="block px-3 py-2 rounded-md text-base font-medium text-[#A5ACAF] hover:text-[#FD5A1E] hover:bg-[#4d4d4d]/50"
                              onClick={() => {
                                setIsMenuOpen(false);
                    ...
                    <Link
                      key={item.name}
                      href={item.path}
                      className="block px-3 py-2 rounded-md text-base font-medium text-[#F5F5F5] hover:bg-[#4d4d4d] hover:text-[#FD5A1E]"
              ...
              <div className="pt-4 pb-3">
                <Link
                  href="/contact"
                  className="block w-full px-5 py-3 text-center font-medium text-[#F5F5F5] bg-[#FD5A1E] rounded-md hover:bg-[#F5F5F5] hover:text-[#000000]"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Free Consultation
                </Link>
